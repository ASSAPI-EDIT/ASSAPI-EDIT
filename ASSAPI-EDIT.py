...
def banner():
    bannertop = '''
        ...
        \033[0m   [-] │ YOUTUBE    : \033[95mASSAPI-EDIT    [\033[0mcode\033[95m] [\033[0mapi\033[95m]
            \033[0m   [-] │ TIK TOK    : \033[95mASSAPI-EDIT [\033[0mcode\033[95m] [\033[0mapi\033[95m]
            \033[0m   [-] │ FACEBOOK  : \033[95m ทรงเเบด เเต่ เเซดบอย ฯ. [\033[0mcode\033[95m] [\033[0mapi\033[95m]
            \033[0m [-] By: Kiw and PEEM
\033[0m ใช้บริการในดิสคอสได้นะครับมีซื้อขายยศต่างเพื่อใช้งานบริการตามลำดับยศ
    '''
    print(bannertop)
